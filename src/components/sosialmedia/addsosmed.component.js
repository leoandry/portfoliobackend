...
export default class Addsosmed extends Component {
  constructor(props) {
    super(props);
    ...
    axios.post('https://4pilarsinergi.co.id/api-portfolio/public/sosmed/', obj)
  ...
  render() {
    return (
        <div style={{ marginTop: 10 }}>
            <h5 style={{marginLeft: '17%'}}>TAMBAH DATA SOSIAL MEDIA</h5>
